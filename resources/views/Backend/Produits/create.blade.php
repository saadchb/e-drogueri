                    ...
                    <form action="{{route('Produits.store')}}" class="mt-4" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <label for="prix_vente"><strong> Prix  vente</strong></label>
                        ...
                        <div class="form-row col">
                            ...
                            <br>
                                <div class="custom-control custom-checkbox mt-3">
                                    <input type="checkbox" name="featured_product" class="custom-control-input" id="featured_product" {{ old('featured_product') ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="featured_product"> Make this categorie showup in homepage of siteweb</label>
                                </div>
                        </div>
